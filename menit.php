...
<div class="border-bawah">
	<p><h3><u>Menit ke Detik</u></h3></ali</p>
	<p><form method="post"><input type="number" name="menit" placeholder="Masukan menit" value=""> <button type="submit" name="sub"  style="height: 20px;">Submit</button></form></p>
	<p><h3>Hasil</h3></p>
	<p><?php
if(isset($_POST['sub'])){
	$menit = $_POST['menit'];
	$detik = 60;
	if ($hitung = $menit * $detik){
		echo  number_format($hitung)." Detik ";
	}
} 
?></p>
